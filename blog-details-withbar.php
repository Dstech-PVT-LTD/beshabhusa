                ...
                <div class="col-12">
                    ...
                    <div class="page-title-wrap">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="active"><a href="#">Blog Details with sidebar</a></li>
                        </ul>
                                                    ...
                                                    <ul>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <div class="d-flex single-post-comment">
                                                                        ...
                                                                        <div class="avatar-details">
                                                                            <h6>Nicolus Harzerd</h6><span class="commnet-time">2d ago</span>
                                                                            <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment</p>
                                                                            <a href="#">Reply<span><i class="fa fa-reply"></i></span></a>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="d-flex single-post-comment">
                                                                ...
                                                                <div class="avatar-details">
                                                                    <h6>Kendra Nixion</h6><span class="commnet-time">2d ago</span>
                                                                    <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment</p>
                                                                    <a href="#">Reply<span><i class="fa fa-reply"></i></span></a>
                                                                </div>
                                                            </div>
