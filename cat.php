...
$fetchProductsStmt = $conn->prepare("SELECT * FROM `products`WHERE `catId` =?");

$fetchProductsStmt->execute([$cid]);
?>
            ...
            <div class="col-12">
                ...
                <div class="page-title-wrap">
                    <div class="page-title-heading">
                        <h1 class="h2">Shop Page<span>Shopping</span></h1>
                    </div>
                                                        ...
                                                        <div class="shope-filter-item">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <ul class="size-list">
                                                                        <li>
                                                                            <input id="larg_size" type="radio" style="display: none;" name="equll_size">
                                                                            <label for="larg_size"><a class="product-size"><span>L</span></a></label>
                                                                        </li>
                                                                        <li>
                                                                            <input id="medium_size" type="radio" style="display: none;" name="equll_size">
                                                                            <label for="medium_size"><a class="product-size"><span>M</span></a></label>
                                                                        </li>
                                                                        <li>
                                                                            <input id="small_size" type="radio" style="display: none;" name="equll_size">
                        ...
                        <div class="tab-content shop-tab-content">
                            <div class="tab-pane fade show active" role="tabpanel" id="fourcol" aria-labelledby="nav-four-col">
                                <div class="row">
                                    ...
                                    $sl = 1;
                                    while ($row = $fetchProductsStmt->fetch()) {
                                                    ...
                                                    <div class="product-thumb">
                                                        ...
                                                        <div class="product-image">
                                                            <a href="shop-details.php?id=<?php echo $id; ?>">
                                                                <img class='normal-state' data-rjs="2" src="<?php echo $row['image']; ?>" alt="category image <?php echo $sl; ?>">
                    ...
                    <div class="single-sidebar-widget widget_nav_menu mb-60">
                        ...
                        <div class="single-widget-size">
                            <ul class="size-list mb-0 list-unstyled">
                                <li>
                                    <input id="larg_size1" type="radio" style="display: none;" name="equll_size1">
                                    <label for="larg_size1"><a class="product-size"><span>L</span></a></label>
                                </li>
                                <li>
                                    <input id="medium_size1" type="radio" style="display: none;" name="equll_size1">
                                    <label for="medium_size1"><a class="product-size"><span>M</span></a></label>
                                </li>
                                <li>
                                    <input id="small_size1" type="radio" style="display: none;" name="equll_size1">
                                    <label for="small_size1"><a class="product-size"><span>S</span></a></label>
                                </li>
                            </ul>
                        </div>
                    </div>
