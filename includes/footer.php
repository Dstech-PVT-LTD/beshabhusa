                    ...
                    <div class="col-md-6 col-lg-4 col-sm-6">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="assets/img/beshabhusa.png" width="100px" alt=""></a>
                            </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="footer-contact-list list-unstyled mb-0">
                                <li>
                                    ...
                                    1st,144,Cuttack Road,Old Post Office Lane,Laxmisagar,BBSR,Khurda,Odisha
                                </li>
                                <li>
                                    <span><i class="fa fa-envelope" aria-hidden="true"></i></span>
                                    <a href="mailto:beshabhusa@gmail.com">Email: info@beshabusha@gmail.com</a>
                                </li>
                                <li>
                                    <span><i class="fa fa-phone" aria-hidden="true"></i></span>
                                    <a href="tel:6743158370">Phone: +91 6743158370</a>
                                </li>
                                <li>
                                    <span><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                    Monday - Saturday:9:00 - 20:00 pm
                                </li>
                            </ul>
                        </div>
                          <!-- footer social area -->
                ...
                <div class="row">
                    ...
                    <div class="footer-bottom-wrap">
                        ...
                        <div class="copyright-text col-md-6">
                            <p>© 2023 <a href="#">BESHABUSHA </a> All rights reserved</p>
                        </div>
                        <!-- End of copyright text -->

                        <!-- tarms and condition -->
                        <div class="trams-conditaion col-md-6">
                            <a href=https://www.dstechsales.com/ target="_blank"><img src="dstechlogo.png" alt="dstech"
                                    style="max-width:10%;float:right;"></a>
                        </div>
...
function updateTotal() {
    ...
    ?>
    var quantity = parseInt($('#quantity_<?php echo $row['id']; ?>').val());
    var price = parseInt($('#price_<?php echo $row['id']; ?>').text());
    var subTotal = quantity * price;
    totalSubTotal += subTotal;
    <?php } ?>
    $('#product_total_amt').text(totalSubTotal.toFixed(2));
}
</script>
